...
router.delete('/jobs/alert/:jobSearchAlertId', jobsController.deleteJobAlert.bind(jobsReferralController)); 
router.post('/jobs/statistics', jobsController.getJobStatistics.bind(jobsController)); 
