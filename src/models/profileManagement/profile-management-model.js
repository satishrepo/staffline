            ...
            .then((details) => {
                ...
                if (details.length) {
                    details.forEach(function (item) {
                        ...
                        if (item.docType == enums.doc.type.resume) {
                            resume.push(
                                {
                            ...
                            documents.push(
                                {
                                    ...
                                    // filePath: (item.filePath) ? config.apiHostUrl + '/' + config.imageFolder + item.filePath : '',
                                    uploadedDate: item.uploadedDate
                                })
                        }
                ...
                return { documents: documents, resume: resume };
            })
    }
